  ...
  const saveScreeningResult = async (
    ...
    try {
      const sessionId = await addScreeningSession({
        ...
        analisis_gabungan: summaryParts.join("\n"),
        rekomendasi: recommendationParts.join("\n"),
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.permissionContainer}>
          ...
          <TouchableOpacity style={styles.bypassBtn} onPress={toggleBypass}>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.bypassToggle} onPress={toggleBypass}>
            <Text style={styles.bypassToggleText}>
              AI Mode: {isBypass ? "Simulasi" : "On-Device ONNX"}
            </Text>
            <View style={[styles.toggleDotContainer, isBypass ? styles.toggleActive : styles.toggleInactive]}>
